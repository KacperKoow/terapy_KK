...
from terapy_2.core.plotpanel import PlotPanel
from terapy_2.core.dragdrop import FilterDrop, FilterDragObject
from wx.lib.pubsub import setupkwargs
from wx.lib.pubsub import pub
from terapy_2.filters import GetModules, FilterBank
import functools
...
class FilterControl(wx.Panel):
    ...
    def __init__(self, parent = None, dim = 1):
        ...
        from terapy_2.core import left_width
        self.bank = None
        self.dim = dim
    ...
    def OnSaveDefaultFilters(self, inst=None):
        ...
        """
        from terapy_2.core import filter_file
        if filter_file==None:
