...
import wx.grid
from terapy_2.core.validator import PositiveFloatValidator, PositiveIntegerValidator
...
class SettingsDialog(wx.Dialog):
    ...
    def OnOk(self, event=None):
        ...
        # store settings
        import terapy_2.core
        for x in settings:
            tp = type(getattr(terapy_2.core,x))
            setattr(terapy_2.core, x, tp(self.slist[x][1]))
        
        # propose to save to disk
        from terapy_2.core import main_config_file, config_path
        import os
    ...
    def SaveSettings(self, fname):
        ...
        from terapy_2.core.axedit import du
