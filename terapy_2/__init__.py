...
# wx for general GUI
import wx
from terapy_2.core.splitter import Splitter
from terapy_2.core.menus import GetItemIds
from wx.lib.pubsub import pub
# plotting and data treatment
from terapy_2.filters.control import FilterControl
from terapy_2.plot.notebook import PlotNotebook
# filesystem handling
from terapy_2.core import user_path
import os
# hardware stuff
import terapy_2.hardware
# scan-related stuff
from time import localtime, strftime
from terapy_2.scan.control import ScanEventList
from terapy_2.core.history import HistoryControl
...
class TeraPyMainFrame(wx.Frame):
    def __init__(self):
        ...
        terapy_2.hardware.restore_hardware_info()
       ...
       #KK self.tree_events.Unfold(3) # unfold 3 levels of event tree
    ...
    def CreateDeviceWidgets(self):
        ...
        self.device_widgets = terapy_2.hardware.get_widgets(self.panel)
    ...
    def __do_layout(self):
        ...
        #KK tu zamieniłem horizontal na vertical
        hbox5.Add(self.progress_bar, 0, wx.ALIGN_CENTER_VERTICAL, 2)
        hbox5.AddStretchSpacer()
    ...
    def OnSettings(self, event):
        ...
        """
        from terapy_2.core.settings import SettingsDialog
    ...
    def OnDefaultUnits(self, event):
        ...
        """
        from terapy_2.core.axedit import AxesPropertiesDialog, AxisInfos, du
    ...
    def OnResetHardware(self, event = None):
        ...
        print ("reset...")
        for x in terapy_2.hardware.devices['axis']:
            print ("reset", x.name)
            x.reset()        
        for x in terapy_2.hardware.devices['input']:
            print ("reset", x.name)
            x.reset()        
    ...
    def OnScanHardware(self, event):
        ...
        # scan hardware
        terapy_2.hardware.scan_hardware()
        terapy_2.hardware.store_hardware_info()
        terapy_2.hardware.initiate_hardware()    # boot devices
    ...
    def OnConfigureInput(self, event):
        ...
        terapy_2.hardware.devices["input"][mId].configure()
        terapy_2.hardware.store_hardware_info()
    ...
    def OnConfigureAxis(self, event):
        ...
        mId = GetItemIds(event.GetEventObject()).index(event.GetId())
        self.StopDeviceTimer()                        # stop signal refresh        
        terapy_2.hardware.devices["axis"][mId].configure()
        terapy_2.hardware.store_hardware_info()
        self.StartDeviceTimer()                        # restart signal refresh
