...
import os
from terapy_2.filters.base import Filter
from terapy_2.core import check_py, filter_file
from terapy_2.core.parsexml import ParseAttributes
from terapy_2.core.dataman import DataArray
from terapy_2.core.axedit import AxisInfos
...
def GetFilterFiles(dim=1):
    ...
    from terapy_2.core import filter_path
    bank = FilterBank()
...
from terapy_2.core import parse_modules
modules = parse_modules(__package__, curdir, Filter)

# search for custom modules
from terapy_2.core import module_path
